...
export async function GET() {
  try {
    ...
    sortedData.forEach(row => {
      ...
      switch (row.chartName) {
        ...
        case 'Historical Data':
          ...
          console.log(`  Updated historical data for ${historicalMonth}: P21=${historicalDataPoint?.sales}, POR=${historicalDataPoint?.orders}`);
          break;
        ...
        case 'AR Aging':
          ...
          let arDataPoint = dashboardData.arAging.find(a => a.range === arDate);
    ...
    dashboardData.dailyOrders.sort((a, b) => {
      const aNum = a.date ? parseInt(a.date) : 0;
      const bNum = b.date ? parseInt(b.date) : 0;
      return aNum - bNum;
    });
