...
export function ServerConnectionDialog({ 
  ...
  const [filePath, setFilePath] = useState<string>('C:\\Users\\BobM\\Desktop');
  
  // Store POR file path in local storage
  const [storedFilePath, setStoredFilePath] = useLocalStorage<string>('por-file-path', 'C:\\Users\\BobM\\Desktop');
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="C:\\Users\\BobM\\Desktop"
              />
