...
interface ConnectionDialogProps {
  ...
  onSave: (p21Config: ServerConfig, porConfig: ServerConfig) => void;
  initialP21Config?: ServerConfig;
  initialPORConfig?: ServerConfig;
}
...
export function ConnectionDialog({
  ...
  const [p21Config, setP21Config] = useState<ServerConfig>(initialP21Config || defaultP21Config);
  const [porConfig, setPORConfig] = useState<ServerConfig>(initialPORConfig || defaultPORConfig);
  ...
  const handleP21Change = (field: keyof ServerConfig, value: string | boolean | number) => {
    setP21Config((prev) => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handlePORChange = (field: keyof ServerConfig, value: string | boolean | number) => {
    setPORConfig((prev) => ({
      ...prev,
      [field]: value,
    }));
          ...
          <TabsContent value="p21" className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleP21Change('port', Number(e.target.value))}
                placeholder="1433"
              />
            </div>
          ...
          <TabsContent value="por" className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handlePORChange('useWindowsAuth', Boolean(checked))}
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handlePORChange('username', e.target.value)}
                    placeholder="sa"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handlePORChange('password', e.target.value)}
                    placeholder="Password"
                  />
                </div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handlePORChange('port', Number(e.target.value))}
                placeholder="1433"
              />
            </div>
