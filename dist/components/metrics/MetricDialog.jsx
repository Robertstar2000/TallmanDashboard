...
export function MetricDialog({ isOpen, title, value, onClose, onSave }) {
    ...
    return (<Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <Input type="number" value={newValue} onChange={(e) => setNewValue(e.target.value)} className="text-lg" autoFocus/>
        </div>
