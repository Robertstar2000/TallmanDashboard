 ...
 */
export function clearHash(contentWindow) {
 ...
 */
export function replaceHash(url) {
 ...
 */
export function blockReloadInHiddenIframes() {
 ...
 */
export function blockRedirectInIframe(allowRedirectInIframe) {
 ...
 */
export function blockAcquireTokenInPopups() {
 ...
 * @param initialized
 */
export function blockAPICallsBeforeInitialize(initialized) {
    if (!initialized) {
 ...
 * @param initialized
 */
export function preflightCheck(initialized) {
 ...
 * @param config
 */
export function redirectPreflightCheck(initialized, config) {
 ...
 * @returns
 */
export function preconnect(authority) {
