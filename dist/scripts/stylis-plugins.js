import { alloc, dealloc, delimit, from, next, peek, position, slice, token } from 'stylis';
...
const isIgnoringComment = (element) => element.type === 'comm' &&
...
let isImportRule = (element) => element.type.charCodeAt(1) === 105 && element.type.charCodeAt(0) === 64;
