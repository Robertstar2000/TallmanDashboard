...
import { getRules } from "./compile/rules";
...
function requiredOptions(o) {
    ...
    const uriResolver = (_d = o.uriResolver) !== null && _d !== void 0 ? _d : DefaultUriResolver;
    return {
...
class Ajv {
    ...
    addKeyword(kwdOrDef, def // deprecated
        ...
        const definition = Object.assign(Object.assign({}, def), { type: getJSONTypes(def.type), schemaType: getJSONTypes(def.schemaType) });
...
function addRule(keyword, definition, dataType) {
    ...
    const rule = {
        keyword,
        definition: Object.assign(Object.assign({}, definition), { type: getJSONTypes(definition.type), schemaType: getJSONTypes(definition.schemaType) }),
    };
