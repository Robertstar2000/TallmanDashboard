...
const { CloseParen: PAREN_CLOSE, Comment: COMMENT, EOF, Ident: IDENT, Whitespace: W_SPACE } = TokenType;
 ...
 */
export function resolveVar(value, opt = {}) {
    const { format = '' } = opt;
    if (isString(value)) {
