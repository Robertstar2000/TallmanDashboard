...
export const ClientAuthErrorMessage = {
    ...
    clientInfoEmptyError: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.clientInfoEmptyError],
    },
    tokenParsingError: {
    ...
    endpointResolutionError: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.endpointResolutionError],
    },
    networkError: {
    ...
    multipleMatchingTokens: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.multipleMatchingTokens],
    },
    multipleMatchingAccounts: {
        code: ClientAuthErrorCodes.multipleMatchingAccounts,
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.multipleMatchingAccounts],
    },
    multipleMatchingAppMetadata: {
        code: ClientAuthErrorCodes.multipleMatchingAppMetadata,
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.multipleMatchingAppMetadata],
    },
    ...
    removeEmptyScopeError: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.cannotRemoveEmptyScope],
    },
    appendScopeSetError: {
    ...
    NoAccountInSilentRequest: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.noAccountInSilentRequest],
    },
    invalidCacheRecord: {
    ...
    invalidCacheEnvironment: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.invalidCacheEnvironment],
    },
    noAccountFound: {
    ...
    unexpectedCredentialType: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.unexpectedCredentialType],
    },
    invalidAssertion: {
    ...
    tokenRefreshRequired: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.tokenRefreshRequired],
    },
    userTimeoutReached: {
    ...
    bindingKeyNotRemovedError: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.bindingKeyNotRemoved],
    },
    logoutNotSupported: {
        code: ClientAuthErrorCodes.endSessionEndpointNotSupported,
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.endSessionEndpointNotSupported],
    },
    keyIdMissing: {
    ...
    noNetworkConnectivity: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.noNetworkConnectivity],
    },
    userCanceledError: {
    ...
    missingTenantIdError: {
        ...
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.missingTenantIdError],
    },
    nestedAppAuthBridgeDisabled: {
        code: ClientAuthErrorCodes.nestedAppAuthBridgeDisabled,
        desc: ClientAuthErrorMessages[ClientAuthErrorCodes.nestedAppAuthBridgeDisabled],
    },
};
/**
...
export function createClientAuthError(errorCode, additionalMessage) {
