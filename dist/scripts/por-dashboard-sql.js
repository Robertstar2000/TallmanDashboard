        ...
        try {
            ...
            for (const expr of porExpressions) {
                ...
                for (const porSql of POR_SQL_EXPRESSIONS) {
                    if (dataPoint.toLowerCase().includes(porSql.name.toLowerCase()) ||
                        ...
                        updatedExpressions.push(Object.assign(Object.assign({}, expr), { sqlExpression: porSql.sql, updated: true }));
                        matchFound = true;
                        break;
                    }
                }
                ...
                if (!matchFound) {
                    updatedExpressions.push(Object.assign(Object.assign({}, expr), { updated: false }));
                }
            }
