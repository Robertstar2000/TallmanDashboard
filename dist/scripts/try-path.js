 ...
 */
export function getPathsToTry(extensions, absolutePathMappings, requestedModule) {
...
export function getStrippedPath(tryPath) {
...
export function exhaustiveTypeException(check) {
