...
export const METADATA_HEADER_NAME = "Metadata";
export const APP_SERVICE_SECRET_HEADER_NAME = "X-IDENTITY-HEADER";
export const ML_AND_SF_SECRET_HEADER_NAME = "secret";
export const API_VERSION_QUERY_PARAMETER_NAME = "api-version";
export const RESOURCE_BODY_OR_QUERY_PARAMETER_NAME = "resource";
