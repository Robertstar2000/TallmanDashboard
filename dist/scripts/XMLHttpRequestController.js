...
import { decodeBuffer, encodeBuffer, toArrayBuffer, } from '../../utils/bufferUtils';
...
export class XMLHttpRequestController {
            ...
            methodCall: ([methodName, args], invoke) => {
                ...
                switch (methodName) {
                    ...
                    case 'send': {
                        ...
                        const onceRequestSettled = ((_a = this.onRequest) === null || _a === void 0 ? void 0 : _a.call(this, {
                            request: fetchRequest,
                            requestId: this.requestId,
                        })) || Promise.resolve();
    ...
    get responseXML() {
        invariant(this.request.responseType === '' ||
