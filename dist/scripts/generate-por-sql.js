...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // Find date column
            const dateColumn = bestTableColumns.find(col => col.toLowerCase().includes('date') ||
                col.toLowerCase().includes('time') ||
                col.toLowerCase().includes('created')) || 'Date';
            // Find status column
            const statusColumn = bestTableColumns.find(col => col.toLowerCase().includes('status') ||
                col.toLowerCase().includes('state') ||
                col.toLowerCase().includes('type')) || 'Status';
            // Find amount column
            const amountColumn = bestTableColumns.find(col => col.toLowerCase().includes('amount') ||
                col.toLowerCase().includes('value') ||
                col.toLowerCase().includes('price') ||
                col.toLowerCase().includes('cost') ||
                col.toLowerCase().includes('total')) || 'Amount';
            ...
            console.log(`New Rentals Jan: ${(_a = sqlExpressions.find(expr => expr.name === 'POR New Rentals Jan')) === null || _a === void 0 ? void 0 : _a.sql}`);
