...
it('returns false and prints an error for implicitly non-configurable global property', () => {
    ...
    expect(console.error).toHaveBeenCalledWith('[MSW] Failed to apply interceptor: the global `_implicitlyNonConfigurable` property is non-configurable. This is likely an issue with your environment. If you are using a framework, please open an issue about this in their repository.');
});
it('returns false and prints an error for explicitly non-configurable global property', () => {
    ...
    expect(console.error).toHaveBeenCalledWith('[MSW] Failed to apply interceptor: the global `_explicitlyNonConfigurable` property is non-configurable. This is likely an issue with your environment. If you are using a framework, please open an issue about this in their repository.');
});
it('returns false and prints an error for global property that only has a getter', () => {
    ...
    expect(console.error).toHaveBeenCalledWith('[MSW] Failed to apply interceptor: the global `_onlyGetter` property is non-configurable. This is likely an issue with your environment. If you are using a framework, please open an issue about this in their repository.');
});
