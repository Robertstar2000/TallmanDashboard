...
import { Interceptor, getGlobalSymbol, deleteGlobalSymbol, InterceptorReadyState, } from './Interceptor';
...
describe('readyState', () => {
    ...
    it('leaves state as "INACTIVE" if the interceptor failed the environment check', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('perfroms state transition when the interceptor is applying', () => __awaiter(void 0, void 0, void 0, function* () {
        const interceptor = new Interceptor(symbol);
        interceptor.apply();
    ...
    it('perfroms state transition when disposing of the interceptor', () => __awaiter(void 0, void 0, void 0, function* () {
        const interceptor = new Interceptor(symbol);
        interceptor.apply();
        interceptor.dispose();
...
describe('apply', () => {
    it('does not apply the same interceptor multiple times', () => {
        const interceptor = new Interceptor(symbol);
        const setupSpy = vi.spyOn(interceptor, 
...
describe('dispose', () => {
    it('removes all listeners when the interceptor is disposed', () => __awaiter(void 0, void 0, void 0, function* () {
        const interceptor = new Interceptor(symbol);
        interceptor.apply();
        const listener = vi.fn();
