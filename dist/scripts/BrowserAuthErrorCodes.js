...
export const hashDoesNotContainKnownProperties = "hash_does_not_contain_known_properties";
...
export const authCodeOrNativeAccountIdRequired = "auth_code_or_nativeAccountId_required";
export const spaCodeAndNativeAccountIdPresent = "spa_code_and_nativeAccountId_present";
export const databaseUnavailable = "database_unavailable";
export const unableToAcquireTokenFromNativePlatform = "unable_to_acquire_token_from_native_platform";
...
export const nativeConnectionNotEstablished = "native_connection_not_established";
export const uninitializedPublicClientApplication = "uninitialized_public_client_application";
