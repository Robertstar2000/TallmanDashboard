...
function generateMonthlyPOCountRows() {
...
function generateMonthlyPOTotalRows() {
    const today = new Date();
    const currentYear = today.getFullYear();
    const currentMonth = today.getMonth() + 1;
    const rows = [];
...
function generateVendorPOCountRows() {
    return [
        {
...
function generateStatusDistributionRows() {
    return [
        {
            chartName: "PO Status",
...
function generateStoreDistributionRows() {
    return [
        {
