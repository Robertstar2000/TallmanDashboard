...
export function executeDbQuery(sqlExpression) {
...
export function executeQuery(serverType, tableName, sqlExpression) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield executeDbQuery(sqlExpression);
            return result;
        }
        catch (err) {
