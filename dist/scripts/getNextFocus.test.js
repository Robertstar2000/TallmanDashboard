...
describe.each(tests)('when focusing the $moveBy $direction $focusedDay', ({ focusedDay, moveBy, direction, context, expectedNextFocus }) => {
...
describe.each(modifiersTest)('when focusing the $moveBy $direction $focusedDay with $modifierName modifier', (modifierTest) => {
    const modifiers = Object.assign(Object.assign({}, emptyModifiers), { [modifierTest.modifierName]: [parseISO(modifierTest.skippedDay)] });
    const context = {
