...
export class RequestValidator {
    ...
    static validateRedirectUri(redirectUri) {
        if (!redirectUri) {
            throw createClientConfigurationError(ClientConfigurationErrorCodes.redirectUriEmpty);
        }
    }
    /**
    ...
    static validatePrompt(prompt) {
        ...
        if (promptValues.indexOf(prompt) < 0) {
            throw createClientConfigurationError(ClientConfigurationErrorCodes.invalidPromptValue);
        }
    }
    ...
    static validateCodeChallengeMethod(codeChallengeMethod) {
        if ([
            ...
            throw createClientConfigurationError(ClientConfigurationErrorCodes.invalidCodeChallengeMethod);
        }
    }
}
