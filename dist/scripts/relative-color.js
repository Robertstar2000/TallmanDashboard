...
/* constants */
import { CS_LAB, CS_LCH, FN_REL, FN_REL_CAPT, FN_VAR, NONE, SYN_COLOR_TYPE, SYN_FN_MATH_START, SYN_FN_VAR, SYN_MIX, VAL_SPEC } from './constant';
const { CloseParen: PAREN_CLOSE, Comment: COMMENT, Dimension: DIM, EOF, Function: FUNC, Ident: IDENT, Number: NUM, OpenParen: PAREN_OPEN, Percentage: PCT, Whitespace: W_SPACE } = TokenType;
...
const MAX_RGB = 255;
/* regexp */
const REG_COLOR_CAPT = new RegExp(`^${FN_REL}(${SYN_COLOR_TYPE}|${SYN_MIX})\\s+`);
    ...
    while (tokens.length) {
        ...
        if (Array.isArray(channel)) {
            switch (type) {
                ...
                case NUM: {
                    channel.push(Number(detail === null || detail === void 0 ? void 0 : detail.value));
                    if (!func) {
                        i++;
                    }
                    break;
                ...
                case PCT: {
                    channel.push(Number(detail === null || detail === void 0 ? void 0 : detail.value) / MAX_PCT);
                    if (!func) {
                        i++;
                    }
                    break;
