 ...
 */
export function getAllAccounts(logger, browserStorage, isInBrowser, accountFilter) {
 ...
 */
export function getAccount(accountFilter, logger, browserStorage) {
 ...
 */
export function getAccountByUsername(username, logger, browserStorage) {
 ...
 * @returns The account object stored in MSAL
 */
export function getAccountByHomeId(homeAccountId, logger, browserStorage) {
 ...
 * @returns The account object stored in MSAL
 */
export function getAccountByLocalId(localAccountId, logger, browserStorage) {
 ...
 * @param account
 */
export function setActiveAccount(account, browserStorage) {
    browserStorage.setActiveAccount(account);
}
/**
 * Gets the currently active account
 */
export function getActiveAccount(browserStorage) {
