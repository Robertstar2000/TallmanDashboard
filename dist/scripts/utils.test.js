...
describe('trailing slash redirects', () => {
    it('adds a trailing slash to the pathn if trailingSlash is enabled', () => {
        ...
        assertEquals(result === null || result === void 0 ? void 0 : result.status, 308);
        assertEquals(result === null || result === void 0 ? void 0 : result.headers.get('location'), 'https://example.com/foo/');
    });
    ...
    it('adds a trailing slash if there is a dot in the path', () => {
        ...
        const result = redirectTrailingSlash(url, true);
        assertEquals(result === null || result === void 0 ? void 0 : result.status, 308);
        assertEquals(result === null || result === void 0 ? void 0 : result.headers.get('location'), 'https://example.com/foo.bar/baz/');
    });
    ...
    it('removes a trailing slash from the path if the path is a file', () => {
        ...
        const result = redirectTrailingSlash(url, false);
        assertEquals(result === null || result === void 0 ? void 0 : result.status, 308);
        assertEquals(result === null || result === void 0 ? void 0 : result.headers.get('location'), 'https://example.com/foo.txt');
    });
});
