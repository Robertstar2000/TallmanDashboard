...
it('emits "finished" on .end() without any arguments', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('updates the writable state on "socket.end()"', () => __awaiter(void 0, void 0, void 0, function* () {
    const finishListener = vi.fn();
...
it('updates the readable state on "socket.push(null)"', () => __awaiter(void 0, void 0, void 0, function* () {
    const endListener = vi.fn();
    const socket = new MockSocket({
        write: vi.fn(),
        read: vi.fn(),
...
it('updates the readable/writable state on "socket.destroy()"', () => __awaiter(void 0, void 0, void 0, function* () {
    const finishListener = vi.fn();
    const endListener = vi.fn();
