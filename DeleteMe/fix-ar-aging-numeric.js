...
/**
 * Script to update the AR Aging values in the SQLite database with numeric values
 * This script will convert the formatted currency strings to numeric values
 */
async function updateArAgingNumeric() {
  console.log('=== Updating AR Aging Values to Numeric Format ===');
  ...
  try {
    ...
    const expectedValues = [
      ...
      { variableName: '61-90 Days', value: 1168 },
      { variableName: '90+ Days', value: 9568728 }
    ];
    ...
    // Update each value
    console.log('\n--- Updating AR Aging values to numeric format ---');
    ...
    updatedRows.forEach(row => {
      ...
      const isCorrect = Number(row.value) === expectedValue;
    ...
    console.log('2. The dashboard should now display the correct AR Aging data');
