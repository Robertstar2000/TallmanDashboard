...
const problemExpressions = [
  {
    ...
    pattern: /name:\s+"Orders - New - Month 1"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Orders - Completed - Month 1"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Orders - Cancelled - Month 1"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Orders - New - Month 2"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Orders - Completed - Month 2"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Orders - Cancelled - Month 2"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
  ...
  },
  {
    ...
    pattern: /name:\s+"Inventory - Total Items"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
    fix: "SELECT COUNT(*) as value FROM dbo.inv_mast WITH (NOLOCK)"
  },
  {
    name: "Inventory - Active Items",
    pattern: /name:\s+"Inventory - Active Items"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
    fix: "SELECT COUNT(*) as value FROM dbo.inv_mast WITH (NOLOCK) WHERE delete_flag <> 'Y'"
  },
  {
    name: "Inventory - Inactive Items",
    pattern: /name:\s+"Inventory - Inactive Items"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
    fix: "SELECT COUNT(*) as value FROM dbo.inv_mast WITH (NOLOCK) WHERE delete_flag = 'Y'"
  },
  {
    name: "Customers - Total",
    pattern: /name:\s+"Customers - Total"[\s\S]+?productionSqlExpression:\s+"([^"]+)"/,
