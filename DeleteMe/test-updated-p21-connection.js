// Test script to verify our updated P21 connection settings
// This script tests the direct SQL Server connection to P21 using the updated server name
...
async function testP21Connection() {
  console.log('Testing P21 connection with updated settings...');
  
  try {
    // Create a SQL Server configuration for P21 based on ODBC settings
    const sqlConfig = {
      server: 'SQL01', // Updated server name from ODBC configuration
      database: 'P21Play',
      options: {
