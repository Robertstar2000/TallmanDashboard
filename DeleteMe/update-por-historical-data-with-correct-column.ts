/**
 * Update POR Historical Data with Correct Column
 * 
 * This script updates the admin_variables table with the correct SQL queries
 * for the POR Historical Data rows, using the verified TotalAmount column.
 */
...
async function updatePorHistoricalData() {
  try {
    console.log('Updating POR Historical Data with correct column...');
    ...
    const porHistoricalRows: AdminVariable[] = [];
