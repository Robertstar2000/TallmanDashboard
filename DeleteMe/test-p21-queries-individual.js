...
async function testQueriesIndividually() {
  console.log('=== P21 SQL Query Individual Test ===');
  ...
  try {
    ...
    for (const queryItem of queriesToTest) {
      ...
      // Add a small delay between queries to ensure console output doesn't get mixed
