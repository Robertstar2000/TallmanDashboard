...
const por_schema_1 = require("../lib/db/por-schema");
...
const CONFIG = {
    ...
    OUTPUT_FILE: path_1.default.join(process.cwd(), 'scripts', 'fixed-por-sql-expressions.json'),
    SOURCE_FILE: path_1.default.join(process.cwd(), 'lib', 'db', 'complete-chart-data.ts'),
    BACKUP_FILE: path_1.default.join(process.cwd(), 'lib', 'db', `complete-chart-data.ts.backup-${new Date().toISOString().replace(/:/g, '-')}`),
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            fs_1.default.copyFileSync(CONFIG.SOURCE_FILE, CONFIG.BACKUP_FILE);
            ...
            const availableTables = (0, por_schema_1.getPORTableNames)();
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    function tryNextTable() {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            const columns = (0, por_schema_1.getPORTableColumnNames)(tableInfo.tableName);
...
function loadChartData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const fileContent = fs_1.default.readFileSync(CONFIG.SOURCE_FILE, 'utf8');
...
function rankTablesByRelevance(tables, dataPoint, variableName, chartGroup, extractedColumns, extractedTable) {
    ...
    for (const tableName of tables) {
        ...
        const tableColumns = (0, por_schema_1.getPORTableColumnNames)(tableName);
...
function testSqlExpression(sql) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield (0, node_fetch_1.default)(`${CONFIG.SERVER_URL}/api/test-sql`, {
                method: 'POST',
...
function saveResults(fixedExpressions) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            fs_1.default.writeFileSync(CONFIG.OUTPUT_FILE, JSON.stringify(fixedExpressions, null, 2));
        }
        catch (error) {
