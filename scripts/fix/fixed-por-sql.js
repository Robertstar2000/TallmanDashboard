...
const CONFIG = {
    ...
    OUTPUT_FILE: path_1.default.join(process.cwd(), 'scripts', 'fixed-por-sql.json')
};
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            fs_1.default.writeFileSync(CONFIG.OUTPUT_FILE, JSON.stringify(sqlExpressions, null, 2));
