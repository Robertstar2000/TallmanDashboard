...
exports.fixPORSqlExpression = fixPORSqlExpression;
exports.getAllPORSqlExpressions = getAllPORSqlExpressions;
exports.fixAllPORSqlExpressions = fixAllPORSqlExpressions;
const single_source_data_1 = require("./single-source-data");
...
function getAllPORSqlExpressions() {
    return single_source_data_1.dashboardData
 ...
 */
function fixAllPORSqlExpressions(availableTables = []) {
