...
function generateMonthlyPOCountSQL(): { name: string; sql: string }[] {
...
function generateMonthlyPOTotalSQL(): { name: string; sql: string }[] {
  const today = new Date();
  const currentYear = today.getFullYear();
  const currentMonth = today.getMonth() + 1;
...
function generateVendorPOCountSQL(): { name: string; sql: string }[] {
  return [
    {
...
function generateStatusDistributionSQL(): { name: string; sql: string }[] {
  return [
    {
...
function generateStoreDistributionSQL(): { name: string; sql: string }[] {
  return [
    {
...
function generateAllQueries(): void {
