...
export async function initializeTestDb(): Promise<void> {
  ...
  if (!testDb) throw new Error('Failed to initialize test database');
}
...
export async function getTestDailyOrders(): Promise<any[]> {
  await initializeTestDb();
...
export async function getTestAccountsPayable(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestPOROverview(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestWebOrders(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestSiteDistribution(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestInventory(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestHistoricalData(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestCustomerMetrics(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
...
export async function getTestARAging(): Promise<any[]> {
  await initializeTestDb();
  return new Promise((resolve, reject) => {
    testDb!.all(`
      SELECT 
