...
function isARAgingData(item: any): item is RawARAgingData {
...
function transformHistoricalData(rawData: any[]): HistoricalDataPoint[] {
  ...
  // Group data by month
  const monthlyData: Record<string, HistoricalDataPoint> = {};
...
function transformAccountsPayable(rawData: any[]): AccountsDataPoint[] {
  ...
  // Group by date
  const dateData: Record<string, AccountsDataPoint> = {};
