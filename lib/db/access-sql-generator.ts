 ...
 */
export function generateAccessSql(sqlExpression: string, tableName: string): string {
 ...
 */
export function generateMonthAccessSql(
  baseTable: string, 
  valueColumn: string, 
  condition: string = '', 
  months: number = 12
 ...
 * @returns MS Access compatible SQL query
 */
export function generateDayAccessSql(
  baseTable: string, 
  valueColumn: string, 
  condition: string = '', 
  days: number = 7
